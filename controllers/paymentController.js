...
const paymentVerification = asyncHandler(async (req, res) => {
  ...
  if (user && isAuthentic) {
    user.razorpay_order_id = req.body.razorpay_order_id || user.razorpay_order_id;
    user.razorpay_payment_id = req.body.razorpay_payment_id || user.razorpay_payment_id;
    user.razorpay_signature = req.body.razorpay_signature || user.razorpay_signature;
